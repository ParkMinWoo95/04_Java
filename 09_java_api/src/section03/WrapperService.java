...
public class WrapperService {
	 ...
	 * - Wrapper Class도 객체이므로 추가적인 필드, 메서드를 제공함
	 */
	...
	public void test1() {
		...
		// Object를 전달 받는(모든 객체를 전달 받는) 메서드 printValue의 전달인자로 작성
		printValue(wrap1);
	}
	...
	public void test3() {
		...
		System.out.println("int 최대 값 : " + Integer.MIN_VALUE);
		System.out.println("----------------------------------");
		...
		System.out.println("dobule 최대 값 : " + Double.MIN_VALUE);
