...
public class VariableEx2 {
	...
	public static void main(String[] agrs) {
		 ...
		 *   연산 시 "컴파일러(번역기"가 자동으로 값의 범위가 [작은] 값을 큰 범위의 자료형으로 변경
		 */
		...
		// [int result1 = double]
		// -> 자료형이 같지 않아 연산 불가
		// -> 변수 선언 자료형 int처럼 명시한 자료형은 자동형변환의 대상 X
		...
		// 왜 결과가 1.5가 아니라 1?
		// - 값 처리 원칙에 의해서 int / int의 결과는 무조건 int가 되야 되기 때문에
		// 	 컴파일러가 1.5(double)을 1(int)로 자동 형변화
