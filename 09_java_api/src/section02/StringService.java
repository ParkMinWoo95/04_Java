...
public class StringService {
	...
	public void test1() {
		...
		// String System.identityHashCode(Obejct obj);
		// -> 객체를 구분하는 해시코드 반환
	 ...
	 * - String 리터럴("")를 이용해 생성된 String 객체가 저장되는 Heap 내부 영역
	...
	public void test3() {
		 ...
		 * - 문자열의 추가/수정/삭제가 발생해도 별도의 String 객체 생성이 없어서 메모리 효율이 좋음
		...
		// toString() : StirngBuilder 객체에 저장된 값을 String 형태로 반환
		
		System.out.println("-------------------------------------");
		System.out.println("sb.toString() : " + sb.toString());
		System.out.println("sb크기 : " + sb.capacity());
		...
		// delete(int start, int end) : start ~ end 사이 삭제
		sb.delete(4,9);
		System.out.println("-------------------------------------");
		System.out.println("sb.toString() : " + sb.toString());
		System.out.println("sb크기 : " + sb.capacity());
