...
public class TestRun {
	public static void main(String[] args) {
		 ...
		 * 	 참조변수를 자식캐스팅으로 되돌리는 것.
		 */
		
		// 업캐스팅 확인
		// 부모 참조 변수 = 자식 객체
		// -> 값 처리 원칙을 무시한게 아닌 자식 객체 내 부모 객체 부분만 참조하였기 때문에 가능하다
		...
		// System.out.println("p2.getCar() : " + p2.getCar());
		
		System.out.println("--------------------------------------------");
		System.out.println("p2.getCar() : " + ((Child)p2).getCar());
