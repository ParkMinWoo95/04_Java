...
public class ArrayService1 {
	...
	public void method1() {
		// (참고)
		int num;
		// int 자료형을 저장하기위한 공간을 메모리에 할당하고 해당 공간의 이름을 "num"이라고 지정
		// -> 실제 정수 값을 저장 가능
		...
		// int[] 자료형을 저장하기 위한 공간(변수)을 메모리에 할당하고 해당 공간의 이름을 "arr"이라고 지정
		// -> 배열이 존재하는 위치(쭈소) 저장 가능
	...
	// 오늘의 점심 메뉴 뽑기
	public void method3() {
		String[] menus = {"순대국", "닭갈비", "마라탕", "햄버거", "돈까스", "짜장면", "짬뻥", "포케"};
	...
	public void method5() {
		...
		System.out.printf("최대값 : ", scoreArr[maxIndex]);
		System.out.printf("최소값 : ", scoreArr[minIndex]);
	}
