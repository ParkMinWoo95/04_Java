 ...
 * 		 -> 화면을 통해서 프로그램과 사용자가 접촉함(화면이 접점의 역할)
 * 
 * - 자바(객체 지향 프로그래밍)에서는 객체 간의 접점을 만드는 용도로 사용
 * 
 * - 효과
 ...
 * 
 * [참고]
 * 대부분의 인터페이스를 상속받은 클래스는 인터페이스에서 제공하는 메서드만
 * 오버라이딩하고 별도의 필드/메서드를 작성하지 않는다
 * (약속, 규약)
