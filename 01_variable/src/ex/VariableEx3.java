...
public class VariableEx3 {
	public static void main(String[] args) {
		...
		System.out.println("num2 : " + num2); // 123.99
		...
		for(int i=0; i<5; i++) {
			// Mathrandom() : 0.0 이상 1.0 미만 double형 난수 반환
			int randomNumber = (int)(Math.random() * 10 + 1);
			System.out.println("randomNumber : " + randomNumber);
		}
		
		System.out.println("-------------------");
		System.out.println("[의도적으로 자료형 변환 1]");
		...
		System.out.println("-------------------");
		System.out.println("[의도적으로 자료형 변환 2]");
